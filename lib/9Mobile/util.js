...
module.exports = {
	...
	sendUserConsentSMS(params) {
		...
		let payload = {
			...
			network: '9Mobile',
			sender_id: shortCode,
			content: `You are about to subscribe to ${name}. Service costs N${amount} / ${validity} ${dayValue}. Text 1 to ${shortCode} for Auto renewal or 2 for one-off purchase to continue`,
		}
