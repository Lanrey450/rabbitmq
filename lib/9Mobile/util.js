...
module.exports = {
	...
	sendUserConsentSMS (params){
        const { msisdn, shortCode, name, amount } = params;
		let payload = {
			to: msisdn,
			network: '9Mobile',
			sender_id: shortCode,
	...
	sendUserlowBalanceSMS(params) {
		...
		let payload = {
			...
			network: '9Mobile',
			sender_id: shortCode,
			content: 'Dear Customer, your request was not successful due to insufficient. Please, recahrge and try again. Thank you',
		}
		return this.sendSMS(payload)
	},
