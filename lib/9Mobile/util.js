...
module.exports = {
	...
	sendUserAutoRenewal(data) {
		...
		let payload = {
			...
			network: '9Mobile',
			sender_id: shortCode,
			content: `Hello, your ${serviceName} subscription has been renewed. Service costs N${amount} / ${validity} ${dayValue}. To unsubscribe, text ${unSubscriptionKeyword} to ${shortCode}`,
		}
