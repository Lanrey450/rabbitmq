...
module.exports = {
	...
	sendUserWelcomeSMSforUSSD (params){
        const { msisdn, shortCode, name, amount, validity } = params;
		let payload = {
			to: msisdn,
			network: '9Mobile',
			sender_id: shortCode,
			content: `Hello, your subscription for the ${name} service was successful. Service costs ₦${amount}/${validity} days. To unsubscribe, text HELP to ${shortCode}.`,
		}
