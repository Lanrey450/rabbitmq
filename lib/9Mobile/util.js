...
module.exports = {
	...
	sendUserAutoRenewalUSSD(data) {
		const { shortCode, validity, amount, serviceName, unSubscriptionKeyword } = data;
		let payload = {
			to: '64620',
			network: '9Mobile',
			sender_id: param[5],
			content: `Hello, your renewal for the ${serviceName} Service was successful. To unsubscribe,
								text ${unSubscriptionKeyword} to ${shortCode}. Service costs N${amount} / ${validity} days.`,
		}
