...
module.exports = {
	...
	sendUssd(data) {
		const param = {
			spid: data.spId, service_password: data.spPwd, shortcode: data.shortcode, ussd_string: data.ussd_string, msisdn: data.msisdn, service_id: data.serviceId, option_type: data.option_type, linkid: data.linkid, receiveCB: data.receiveCB, senderCB: data.senderCB,
		}
