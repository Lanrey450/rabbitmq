...
module.exports = {
	...
	async generateToken() {
		...
		// data.append('client_id', config.mtn_client_id)
		// data.append('client_secret', config.mtn_client_secret);
		const data = {
			client_id: config.mtn_client_id,
			client_secret: config.mtn_client_secret
		};
