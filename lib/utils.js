...
const subscriptionUrl = config.subscription_service_url;
...
const subscriptionService = require("axios").create({
	notificationUrl: subscriptionUrl,
	headers: {
		'Authorization': "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..cmOsu6YLWNZLT9xO6h1srYizh_PoIQ5LnTfZr4DtSB0fnJZNFJLjT4ibsRpwVKKzeMSQYaLouARNgBgoM6EMNg"
	}
});
...
module.exports = {
	...
	async getSubscription(payload) {
		...
		console.log('sub urlll', `${subscriptionUrl}api/v1/get-active-by-serviceId`)
		try {
			return (await subscriptionService.get(`api/v1/get-active-by-serviceId`, {
				params: payload
			})).data.data;
		} catch (e) {
